...
export type ComputersResponse<Texpand = unknown> = Required<ComputersRecord> & BaseSystemFields<Texpand>
export type ExecutionsResponse<Texpand = unknown> = Required<ExecutionsRecord> & BaseSystemFields<Texpand>
...
export type TeamsAccessResponse<Texpand = unknown> = Required<TeamsAccessRecord> & BaseSystemFields<Texpand>
export type TeamsLinkResponse<Texpand = unknown> = Required<TeamsLinkRecord> & BaseSystemFields<Texpand>
